...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-10 17:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a968a070-8a50-49ca-9489-b72fcaea720c.git
$ cd a968a070-8a50-49ca-9489-b72fcaea720c
```
